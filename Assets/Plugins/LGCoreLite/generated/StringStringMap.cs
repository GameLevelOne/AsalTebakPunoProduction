...
public class StringStringMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(StringStringMap obj) {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          LGCoreLitePINVOKE.delete_StringStringMap(swigCPtr);
        }
  ...
  public StringStringMap() : this(LGCoreLitePINVOKE.new_StringStringMap__SWIG_0(), true) {
  }

  public StringStringMap(StringStringMap other) : this(LGCoreLitePINVOKE.new_StringStringMap__SWIG_1(StringStringMap.getCPtr(other)), true) {
    if (LGCoreLitePINVOKE.SWIGPendingException.Pending) throw LGCoreLitePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = LGCoreLitePINVOKE.StringStringMap_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = LGCoreLitePINVOKE.StringStringMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    LGCoreLitePINVOKE.StringStringMap_Clear(swigCPtr);
  }

  private string getitem(string key) {
    string ret = LGCoreLitePINVOKE.StringStringMap_getitem(swigCPtr, key);
    if (LGCoreLitePINVOKE.SWIGPendingException.Pending) throw LGCoreLitePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, string x) {
    LGCoreLitePINVOKE.StringStringMap_setitem(swigCPtr, key, x);
    if (LGCoreLitePINVOKE.SWIGPendingException.Pending) throw LGCoreLitePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = LGCoreLitePINVOKE.StringStringMap_ContainsKey(swigCPtr, key);
    if (LGCoreLitePINVOKE.SWIGPendingException.Pending) throw LGCoreLitePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, string val) {
    LGCoreLitePINVOKE.StringStringMap_Add(swigCPtr, key, val);
    if (LGCoreLitePINVOKE.SWIGPendingException.Pending) throw LGCoreLitePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = LGCoreLitePINVOKE.StringStringMap_Remove(swigCPtr, key);
    if (LGCoreLitePINVOKE.SWIGPendingException.Pending) throw LGCoreLitePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = LGCoreLitePINVOKE.StringStringMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = LGCoreLitePINVOKE.StringStringMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    LGCoreLitePINVOKE.StringStringMap_destroy_iterator(swigCPtr, swigiterator);
  }
